...
I = imread('/home/leo/docker_ws/datasets/tinyTimeMachine/6z/6zHPQqtzrPsgvlgACNXC1g/_201407/6zHPQqtzrPsgvlgACNXC1g__201407_35.652096_139.712896_090_012.jpg');
...
%opts.maxBoxArea = gt(3)*gt(4);
%opts.aspectRatio = gt(3)/gt(4);

%% 
[bbs,E]=edgeBoxes(I,model,opts); %Collect 200 Boxes


%% 
bbs1=[]; %make empty list of small boxes
bsize = size(bbs,1); 
for ii=1:bsize
     bb=bbs(ii,:);
     square = bb(3)*bb(4);
